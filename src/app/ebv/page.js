...
export default function EBV() {
    return (
      ...
      <Image src='/ebvScreenshot.png' width={900} height={500} alt="ebv project shop page" className={styles.siteScreenshots}></Image>
                <p className={styles.infoParagraph}>
                    sfds dsfdsfs fdsf sdfsd fdsf dsfds fdsf sdfdsf dsfd sfdsf dsfds fsd fdsfds fdsf dsfds fdsf dsfd sfds fds fdsf dsf dsfds fsd fdsf dsf sdfd sfds fdsf sdf 
                </p>
