    ...
    <div className={styles.wholePageWrapper}>
      ...
      <div className={styles.sectionWrapper}>
        ...
        <p className={styles.infoParagraph}>
          ...
          site would require learning many things I didn't know how to do at the
          time and it was a chance to explore and learn new things in an active
          way.
          <br /> <br />
      ...
      <div className={styles.sectionWrapper}>
        ...
        <p className={styles.infoParagraph}>
          ...
          There is a massive amount of work with API's, data fetching, and data
